...
[node name="Center" type="CenterContainer" parent="UI/Margin"]
size_flags_horizontal = 3
size_flags_vertical = 3

[node name="Card" type="Panel" parent="UI/Margin/Center"]
custom_minimum_size = Vector2(460, 340)
theme_override_styles/panel = SubResource("SB_card")

[node name="Inner" type="VBoxContainer" parent="UI/Margin/Center/Card"]
anchors_preset = 15
offset_left = 32.0
offset_top = 28.0
offset_right = -32.0
...
[node name="LblTitle" type="Label" parent="UI/Margin/Center/Card/Inner"]
size_flags_horizontal = 3
text = "🌙 Maryam Journey"
horizontal_alignment = 1
theme_override_font_sizes/font_size = 28

[node name="LblBismillah" type="Label" parent="UI/Margin/Center/Card/Inner"]
size_flags_horizontal = 3
...
[node name="LblDesc" type="Label" parent="UI/Margin/Center/Card/Inner"]
size_flags_horizontal = 3
...
[node name="LblStars" type="Label" parent="UI/Margin/Center/Card/Inner"]
size_flags_horizontal = 3
...
[node name="Sep" type="HSeparator" parent="UI/Margin/Center/Card/Inner"]
size_flags_horizontal = 3

[node name="BtnStart" type="Button" parent="UI/Margin/Center/Card/Inner"]
size_flags_horizontal = 3
...
[node name="BtnContinue" type="Button" parent="UI/Margin/Center/Card/Inner"]
size_flags_horizontal = 3
...
[node name="BtnReset" type="Button" parent="UI/Margin/Center/Card/Inner"]
size_flags_horizontal = 3
text = "🗑  Hapus Progress"
visible = false
theme_override_styles/normal = SubResource("SB_btn")
